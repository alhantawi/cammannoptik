...
export const LogoLoop: React.FC<LogoLoopProps> = memo(
  ({
    ...
    scaleOnHover = true,
    renderItem,
    ariaLabel = "Marken und Manufakturen",
    className,
    style
  }) => {
    ...
    const cssVariables = useMemo(
      () => ({
        ...
        ...(fadeWidth !== undefined && {
          "--logoloop-fadeWidth": typeof fadeWidth === "number" ? `${fadeWidth}px` : fadeWidth
        }),
        ...(blurStrength !== undefined && {
          "--logoloop-blurStrength": typeof blurStrength === "number" ? `${blurStrength}px` : blurStrength
        }),
        ...(fadeOutColor && { "--logoloop-fadeColor": fadeOutColor })
      }),
      [gap, logoHeight, fadeWidth, blurStrength, fadeOutColor]
    );
    ...
    const renderLogoItem = useCallback(
      (item: LogoItem, key: string) => {
        ...
        const isNodeItem = Boolean(item.node);
        ...
        const itemContent = item.href ? (
          <a
            ...
            href={item.href}
            aria-label={itemAriaLabel || "Markenlink"}
            target="_blank"
